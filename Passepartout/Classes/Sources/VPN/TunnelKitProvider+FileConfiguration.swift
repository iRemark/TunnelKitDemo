...
public struct ParsedFile {
    ...
    public let warning: ApplicationError?
}

public extension TunnelKitProvider.Configuration {
...
//        static let fragment = Utils.regex("^fragment +\\d+")
    ...
    public static func parsed(fromURL url: URL, returnsStripped: Bool = false) throws -> ParsedFile {
